...
export function LearningCard() {
  return (
    <SectionCard
      className={`
        self-start relative overflow-hidden
        ${CARD_CONTAINER}
        bg-[#f4efe2]/95 text-[#243026] border-[#d8ccb6]
      `}
    >
      {/* soft glow */}
      ...
      <div className="pointer-events-none absolute inset-y-0 right-0 w-1/2 bg-gradient-to-r from-transparent via-[#f4efe2]/35 to-[#f4efe2]/10" />
          ...
          {learningItems.map((item) => (
            <div
              ...
              className="
                ...
                hover:-translate-y-1 hover:border-[#8ca069]
                hover:bg-[#ebf0df] hover:text-[#243026]
              "
            >
