...
export function HeroCard() {
  return (
    <SectionCard className="relative overflow-hidden rounded-[2rem] border-2 border-[#1d1d1b] p-6 shadow-[0_12px_35px_rgba(0,0,0,0.18)] md:min-h-[390px]" style={{ backgroundImage: `url('/welcome-bg.jpeg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
