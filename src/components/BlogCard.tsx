...
export function BlogCard({ latestPost }) {
  return (
    <SectionCard className={`${CARD_CONTAINER} bg-[rgba(235,244,248,0.5)] backdrop-blur-md`}>
      <div className={CARD_HEADER}><h3 className={SECTION_TITLE}>Blogs →</h3><a href={blogPreviewData.viewAllUrl} target="_blank" rel="noopener noreferrer" className={BUTTON}>View All<span className="transition-transform duration-300 group-hover:translate-x-1">→</span></a></div>
