...
export function ConnectCard({ socialLinks }) {
  return (
    <SectionCard className={`self-start ${CARD_CONTAINER} bg-[rgba(248,242,235,0.5)] backdrop-blur-md`}>
      <div className={CARD_HEADER}><h3 className={SECTION_TITLE}>Connect →</h3></div>
