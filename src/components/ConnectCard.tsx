...
export function ConnectCard({ socialLinks }) {
  return (
   <SectionCard className={`${CARD_CONTAINER} h-full bg-[#f4efe2]/95 text-[#243026] border-[#d8ccb6]`}>      <div className={CARD_HEADER}><h3 className={SECTION_TITLE}>Connect →</h3></div>
