export const CARD_CONTAINER =
  "rounded-[2rem] border-2 border-[#1d1d1b] p-6 shadow-[0_12px_35px_rgba(0,0,0,0.18)]";

export const CARD_HEADER = "mb-4 flex items-center justify-between";
...
export const BORDERED_PANEL =
  "rounded-2xl border-2 border-[#1d1d1b] bg-[#fffdf8] p-4";
